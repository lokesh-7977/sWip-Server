...
import { getStory } from "../../ReduxAPI/Stories_API";
      ...
      <div className={styles.storyCard}>
        ...
        >
          <div className={styles.storyDes}>
            {/* Display story title with ellipsis for long titles */}
            <h3 className={styles.storyTitle}>
              {story.slides[0].heading &&
                story.slides[0].heading.substring(0, 20)}
              {story.slides[0].heading.length > 30 && "..."}
            </h3>
            {/* Display story content with ellipsis for long content */}
        ...
        {/* Display edit button for authenticated users who added the story */}
